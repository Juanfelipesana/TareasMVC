...
function manejarClickChecboxPaso(paso) {
...
async function borrarPaso(paso) {
    ...
    tareaEditarVM.pasos.remove(function (item) { return item.id() == paso.id() }) //item representa un paso que quiero remover (item.id), id es un observable por eso lleva()
