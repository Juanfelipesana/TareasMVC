...
{
    opciones.SignIn.RequireConfirmedAccount = false; //No requiere verificación de cuenta (que se recibe a un email)
...
app.UseRequestLocalization(opciones =>
{
    ...
    .Select(cultura => new CultureInfo(cultura.Value)).ToList(); //Culturas soportadas, arreglo de string pasado a un listado de culture info.
});
